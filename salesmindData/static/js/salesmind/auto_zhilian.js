$(function () {
    ...
    function check_position1(async) {
        ...
        $.ajax({
            'url': '/spider/check_zhilian_position/?position=' + position,
            'async': async,
    ...
    function check_addr1(async) {
        ...
        $.ajax({
            'url': '/spider/check_zhilian_addr/?addr=' + addr,
            'async': async,
            'success': function (data) {
                if (data.errId != 0) {
    ...
    function check_industry1(async) {
        ...
        $.ajax({
            'url': '/spider/check_zhilian_industry/?industry=' + industry,
            'async': async,
            'success': function (data) {
                if (data.errId != 0) {
    ...
    function check_update1(async) {
        ...
        $.ajax({
            'url': '/spider/check_zhilian_update/?update=' + update,
            'async': async,
            'success': function (data) {
                if (data.errId != 0) {
    ...
    function check_status1(async) {
        ...
        $.ajax({
            'url': '/spider/check_zhilian_status/?status=' + status,
            'async': async,
            'success': function (data) {
                if (data.errId != 0) {
